...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem6.setText("Transparência Gradual");
        jMenuItem6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                applyTransparencyEffect(evt);
            }
        });
    ...
    private void setGrayScale(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
       int width = imagem1.getWidth();
       int height = imagem1.getHeight();
	    for (int i = 0; i < width; i++) {
                for (int j = 0; j < height; j++) { 				
    ...
    private void applyTransparencyEffect(java.awt.event.ActionEvent evt) {
        ...
        for (int i = 0; i < width; i++) {
            for (int j = 0; j < height; j++) {
                Color c = new Color(imagem1.getRGB(i, j));
                int alpha = (int) ((1.0 - (double) j / height) * 255); // Gradual transparency from top to bottom
                Color transparentColor = new Color(c.getRed(), c.getGreen(), c.getBlue(), alpha);
                transparentImage.setRGB(i, j, transparentColor.getRGB());
            }
        }

        imagem1 = transparentImage;
        jLabel1.setIcon(new ImageIcon(imagem1));
        this.repaint();
    }
